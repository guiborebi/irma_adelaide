...
namespace ProjetoIrmaAdelaide
{
    public partial class Form15 : Form
    {
        ...
        private void voltar12_Click(object sender, EventArgs e)
        {
            ...
            this.Close();
            t1 = new Thread(voltar012);
            t1.SetApartmentState(ApartmentState.STA);
            t1.Start();
        }

        //Executando o comando "abrirjanela"
        private void voltar012(object obj)
        {
            Application.Run(new Form3());
        }

        private void anterior12_Click(object sender, EventArgs e)
        {
            //Configuração para abrir nova janela criando o comando "abrirjanela"
            this.Close();
            t2 = new Thread(anterior012);
            t2.SetApartmentState(ApartmentState.STA);
            t2.Start();
        }

        //Executando o comando "abrirjanela"
        private void anterior012(object obj)
        {
            Application.Run(new Form14());
        }

        private void proximo12_Click(object sender, EventArgs e)
        {
            //Configuração para abrir nova janela criando o comando "abrirjanela"
            this.Close();
            t3 = new Thread(proximo012);
            t3.SetApartmentState(ApartmentState.STA);
            t3.Start();
        }

        private void proximo012(object obj)
        {
